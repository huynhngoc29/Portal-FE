  ...
  return (
    <>
      ...
      >
        <div style={{ margin: "0 auto", textAlign: "center" }}>
          ...
          <p className="hero-copy" style={{ margin: "0 auto" }}>
            Khám phá và truy cập nhanh vào các ứng dụng nội bộ từ một nơi duy
            nhất.
          </p>
        </div>
      </section>
      ...
      {error ? (
        ...
        <section
          className="panel"
          style={{ marginTop: "40px", maxWidth: "1000px", margin: "40px auto" }}
        >
          <div
          ...
          {loading ? (
            ...
            <div className="state-box">
              Hiện tại chưa có hệ thống nào được kích hoạt.
            </div>
          ) : (
              ...
              {filteredTools.map((tool) => (
                <article key={tool.id} className="tool-card">
                  ...
                  <p style={{ marginTop: "10px" }}>
                    {tool.description || "Hệ thống tiện ích nội bộ."}
                  </p>
